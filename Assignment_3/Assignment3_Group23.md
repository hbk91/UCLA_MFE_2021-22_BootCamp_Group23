...
- Date Formats are available [here](https://docs.python.org/2/library/datetime.html#strftime-and-strptime-behavior) for parsing string as dates 
- [dateparser library](https://dateparser.readthedocs.io/en/latest/). It can even parse dates even without providing a date format
...
- More details on dtpyes & converters used below while reading data is available [here](https://pbpython.com/pandas_dtypes.html)
- In the above link, specifying dtypes vs. specifying converters while reading data is quite useful 
